...
/**
 * spark-submit --master spark://cloud138:7077 --executor-memory 8g --jars redisclient_2.10-2.12.jar,commons-pool-1.5.6.jar --driver-class-path redisclient_2.10-2.12.jar:commons-pool-1.5.6.jar --class cn.com.gis.shcs.gsmgis0518 sparkgis_2.10-1.0.jar wxy/gsm0819 wxy/gsmout1
 * 与0119版本差在字段顺序和时间上
...
object gsmgis0518 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("gsmgis0518 Application")
    val sc = new SparkContext(conf)

    val finfo = RedisUtils.getResultMap("shgsm0503")

...
object shltegis1yh {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("shltegis1").set("spark.shuffle.compress", "true")
    ...
    // this is also being set in the master's spark-env.sh. Not sure if it needs to be in both places
